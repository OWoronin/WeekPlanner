...
namespace DesktopProjectLib.Models
{
    public class Task : PlannerItem
    {
        ...
        public Task(string name, string dscription, PriorityEnum priority, DifficultyEnum difficulty, StatusEnum status, WeekDaysEnum weekDay, DateTime creationDate, bool partial, bool rescheduled)
